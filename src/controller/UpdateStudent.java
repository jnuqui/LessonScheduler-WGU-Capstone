...
public class UpdateStudent implements Initializable {
    ...
    public void setStudent(int studentID, String name, String phone) {
        this.studentID = studentID;
        this.name = name;
        this.phone = phone;
        studentIdTextField.setText(String.valueOf(studentID));
    ...
    public void updateStudent() throws SQLException {
        ...
        try {
            if (inputCheck() && nameCheck(name) && phoneCheck(phone) && noExistingStudent())
            {
                ...
                StudentDAO.updateStudent(name, phone, studentID);

                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.show();
                alert.setHeaderText("Success.");
                alert.setContentText("Student \"" + name + "\" successfully updated.");
            }
        }
